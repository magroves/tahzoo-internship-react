        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="flex flex-grow">
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              <li>
                <Link to="/clublist" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">Club List</Link>
              </li>
              <li>
                <Link to="/inputclub" className="btn-sm text-gray-200 bg-red-700 hover:bg-orange-600 ml-3">
